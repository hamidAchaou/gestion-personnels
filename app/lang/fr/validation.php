...
return [
    ...
    */
    ...
    'custom' => [
        'annee_juridique_id' => [
            'required' => 'Veuillez choisir une année juridique.',
            'exists' => 'L\'année juridique sélectionnée est invalide.',
        ],
        'nom' => [
            'required' => 'Le nom du jour férié est requis.',
            'max' => 'Le nom du jour férié ne doit pas dépasser :max caractères.',
        ],
        'date_debut' => [
        ...
        'date_fin' => [
            ...
            'date' => 'La date de fin doit être une date valide.',
            'after_or_equal' => 'La date de fin doit être une date postérieure ou égale à la date de début.',
        ],
        'is_formateur' => [
            'required' => 'Le champ Formateur est requis.',
            'boolean' => 'Le champ Formateur doit être vrai ou faux.',
        ],
        'is_administrateur' => [
            'required' => 'Le champ Administrateur est requis.',
            'boolean' => 'Le champ Administrateur doit être vrai ou faux.',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
